...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/WZ.bed'
...
```{r figure.align = "center", fig.height=6, fig.width=9, echo=FALSE}
setwd("~/cophyhopa/results/2022-05-09/admixture/ALPINE")
...
barplot(t(Q[z,]), col = brewer.pal(2, 'Accent'), border = NA,
        ...
        cex.names = 0.8, main = "C.duplex - C.heglingus - C.zuerichensis")

```

```{r figure.align = "center", fig.height=6, fig.width=9, echo=TRUE}
...
write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/BT_all.txt', quote = FALSE,
...
if [ ! -e $FILE.vcf.gz ]; then
   vcftools --vcf $VCF \
            --out dirty \
            --keep ~/cophyhopa/data/ADMX/BT_all.txt \
            --recode \
            --recode-INFO-all
   vcftools --vcf dirty.recode.vcf \
            --out $FILE \
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/BT_all.bed'
...
barplot(t(Q[z,]), col = brewer.pal(4, 'Accent'), border = NA,
        xlab = '', ylab = 'Admixture proportions for K=4', las=2,
        cex.names = 0.8, main = "C.acrinasus - C.fatioi - C.albellus - C.profundus - C.steinmanni")
...
write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/BT_afap.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
if [ ! -e $FILE.vcf.gz ]; then
   vcftools --vcf $VCF \
            --out dirty \
            --keep ~/cophyhopa/data/ADMX/BT_afap.txt \
            --recode \
            --recode-INFO-all
   vcftools --vcf dirty.recode.vcf \
            --out $FILE \
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/BT_afap.bed'
...
barplot(t(Q[z,]), col = brewer.pal(3, 'Accent'), border = NA,
        xlab = '', ylab = 'Admixture proportions for K=3', las=2,
        cex.names = 0.8, main = "C.acrinasus - C.fatioi - C.albellus - C.profundus")
...
write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/BT_afa.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
if [ ! -e $FILE.vcf.gz ]; then
   vcftools --vcf $VCF \
            --out dirty \
            --keep ~/cophyhopa/data/ADMX/BT_afa.txt \
            --recode \
            --recode-INFO-all
   vcftools --vcf dirty.recode.vcf \
            --out $FILE \
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/BT_afa.bed'
...
barplot(t(Q[z,]), col = brewer.pal(2, 'Accent'), border = NA,
        xlab = '', ylab = 'Admixture proportions for K=2', las=2,
        cex.names = 0.6, main = "C.acrinasus - C.fatioi - C.albellus")
...
write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/BT_fa.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
if [ ! -e $FILE.vcf.gz ]; then
   vcftools --vcf $VCF \
            --out dirty \
            --keep ~/cophyhopa/data/ADMX/BT_fa.txt \
            --recode \
            --recode-INFO-all
   vcftools --vcf dirty.recode.vcf \
            --out $FILE \
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/BT_fa.bed'
...
poptable <- poptable[-which(poptable[,3] == "C.fatioi"), ]

write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/BT_afs.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
if [ ! -e $FILE.vcf.gz ]; then
   vcftools --vcf $VCF \
            --out dirty \
            --keep ~/cophyhopa/data/ADMX/BT_afs.txt \
            --recode \
            --recode-INFO-all
   vcftools --vcf dirty.recode.vcf \
            --out $FILE \
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/BT_afs.bed'
...
barplot(t(Q[z,]), col = brewer.pal(2, 'Accent'), border = NA,
        xlab = '', ylab = 'Admixture proportions for K=2', las=2,
        cex.names = 0.6, main = "C.acrinasus - C.fatioi - C.steinmanni")
...
write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/BT_af.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
if [ ! -e $FILE.vcf.gz ]; then
   vcftools --vcf $VCF \
            --out dirty \
            --keep ~/cophyhopa/data/ADMX/BT_af.txt \
            --recode \
            --recode-INFO-all
   vcftools --vcf dirty.recode.vcf \
            --out $FILE \
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/BT_af.bed'
...
barplot(t(Q[z,]), col = brewer.pal(2, 'Accent'), border = NA,
        xlab = '', ylab = 'Admixture proportions for K=2', las=2,
        cex.names = 0.6, main = "C.acrinasus - C.fatioi")
...
write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/BTB_all.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
if [ ! -e $FILE.vcf.gz ]; then
   vcftools --vcf $VCF \
            --out dirty \
            --keep ~/cophyhopa/data/ADMX/BTB_all.txt \
            --recode \
            --recode-INFO-all
   vcftools --vcf dirty.recode.vcf \
            --out $FILE \
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/BTB_all.bed'
...
write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/BTB_afapc.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
if [ ! -e $FILE.vcf.gz ]; then
   vcftools --vcf $VCF \
            --out dirty \
            --keep ~/cophyhopa/data/ADMX/BTB_afapc.txt \
            --recode \
            --recode-INFO-all
   vcftools --vcf dirty.recode.vcf \
            --out $FILE \
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/BTB_afapc.bed'
...
write.table(poptable[,1], file = '~/cophyhopa/data/ADMX/ALL.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/ALL.bed'
...
INPUT='/gata/mar/cophyhopa/results/2022-05-09/admixture/ALPINE/ARC.bed'
