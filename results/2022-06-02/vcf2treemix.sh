...
# [Added by Ignasi to use --chrom-map option in vcftools].
...
plink --file $file --make-bed --out $file --allow-no-sex
plink --bfile $file --freq --missing --within $2 --out $file --allow-no-sex
