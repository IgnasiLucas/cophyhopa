...
write.table(poptable[,1], file = '~/cophyhopa/results/2022-06-02/TREE/ALL.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
...
write.table(poptable[,1], file = '~/cophyhopa/results/2022-06-02/ALP_TREE/ALP.txt', quote = FALSE,
            row.names = FALSE, col.names = FALSE)
