...
plot_tree_internal = function(d, e, o = NA, cex = 1, disp = 0.005, plus = 0.005, arrow = 0.05, 
                              ybar = 0.01, scale = TRUE, mbar = FALSE, mse = 0.01, plotmig = TRUE, 
...
plot_tree = function(stem, o = NA, cex = 1, disp = 0.003, plus = 0.01, flip = vector(), arrow = 0.05, scale = TRUE, 
                     ybar = 0.1, mbar = TRUE, plotmig = T, plotnames = T, xmin = 0, lwd = 1, font = 1){
