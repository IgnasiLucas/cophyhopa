...
```{bash}
if [ ! -e cortree2.log ]; then
   beast -java -threads 16 cortree2.xml
fi
...
```{r}
library(tracerer)
setwd("~/cophyhopa/results/2022-09-21/")

# Parse that log file # needs the full path 
beast_log_full <- parse_beast_tracelog_file("~/cophyhopa/results/2022-09-21/cortree2.log")
